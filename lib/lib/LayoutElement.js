...
exports.LayoutElement = ({ children, componentsRef, setRect, removeComponent, dragRef }) => {
    ...
    return (react_1.default.createElement(MovableLayoutElement_1.default, { id: id, x: visible ? props.x : rect.x, y: visible ? props.y : rect.y, setRect: updateRect, removeComponent: removeComponent, dragRef: dragRef }, children));
};
