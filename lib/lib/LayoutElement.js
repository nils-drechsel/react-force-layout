...
exports.LayoutElement = ({ children, initialX, initialY, setRect, calculateForceVector, removeComponent, size }) => {
    ...
    return (react_1.default.createElement(MovableLayoutElement_1.default, { x: props.x, y: props.y, setRect: updateRect, calculateForceVector: calculateForceVector, removeComponent: removeComponent, drag: drag, setDrag: setDrag, size: size }, children));
};
