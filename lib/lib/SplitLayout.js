...
const wrapElement = (element, componentsRef, setComponents, dimRef, dragRef) => {
...
exports.SplitLayout = ({ children, dimensions }) => {
    ...
    const wrappedChildren = react_1.default.Children.map(children, child => wrapElement(child, componentsRef, setComponents, dimRef, dragRef));
